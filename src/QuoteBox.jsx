...
const QuoteBox = ({ quote, nextPhrase, rgb }) => {
    console.log(rgb)
    return (
        <div className="article">
            <div >
                <p style={{color: rgb}}>{quote.quote}</p>
            </div>
            <span style={{color: rgb}}>{quote.author}</span>
            <picture style={{backgroundColor: rgb}} onClick={nextPhrase}>
